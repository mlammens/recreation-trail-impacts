...
ggplot(data = canopy_dens, aes(x = Site, y = Canopy_Density_Adj_Trail)) +
  ...
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-4-CanDens-Adj.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = papp_trees, aes(x = Location, y = DBH, fill = EcoCondition)) +
  ...
  scale_fill_discrete(name = "Ecological\nCondition",
                      ...
                      labels = c("Disturbed", "Undisturbed", "Ecologically\nSignificant")) +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-4-DBH-Loc-Site.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = nat_inv_plants_tally, aes(x = Location, y = n, fill = EcoCondition)) +
  ...
  scale_fill_discrete(name = "Ecological\nCondition",
                      ...
                      labels = c("Disturbed", "Undisturbed", "Ecologically\nSignificant")) +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-6-PlantRichness-Loc-Site.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = papp_ground_cover_summary, aes(x = Location, y = Tot_Rel_Perc_Cover, fill = EcoCondition)) +
  ...
  scale_fill_discrete(name = "Ecological\nCondition",
                      ...
                      labels = c("Disturbed", "Undisturbed", "Ecologically\nSignificant")) +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-7-RelCov-Loc-Site.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = papp_ground_cover_summary, aes(x = Location, y = Tot_Perc_Cover, fill = EcoCondition)) +
  ...
  scale_fill_discrete(name = "Ecological\nCondition",
                      ...
                      labels = c("Disturbed", "Undisturbed", "Ecologically\nSignificant")) +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-8-Cov-Loc-Site.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = plants_tally, aes(x = Location, y = shannon_ground, fill = EcoCondition)) +
  ...
  scale_fill_discrete(name = "Ecological\nCondition",
                      ...
                      labels = c("Disturbed", "Undisturbed", "Ecologically\nSignificant")) +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-9-Shan-Loc-Site.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = plants_tally, aes(x = Location, y = native_shannon_ground, fill = EcoCondition)) +
  ...
  scale_fill_discrete(name = "Ecological\nCondition",
                      ...
                      labels = c("Disturbed", "Undisturbed", "Ecologically\nSignificant")) +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-10-Nat-Shan-Loc-Site.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = filter(beta_bray_df_long, Site.x == Site.y), aes(x = Site.x, y = beta_bray)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-11-Bray-Tree-Site.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = beta_bray_temp, aes(x = Site.x, y = beta_bray, fill = Location.x)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-12-Bray-Tree-Loc.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = beta_bray_temp, aes(x = Site.x, y = beta_bray)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-13-Bray-Tree-Turn-Loc.png", device = "png", width = 6.5, height = 4, units = "in")
...
ggplot(data = filter(ground_beta_bray_df_long, Site.x == Site.y), aes(x = Site.x, y = ground_beta_bray)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-15-Bray-Veg.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = ground_beta_bray_temp, aes(x = Site.x, y = ground_beta_bray, fill = Location.x)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-16-Bray-Veg-Loc.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = ground_beta_bray_temp, aes(x = Site.x, y = ground_beta_bray)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-17-Bray-Veg-Turn-Loc.png", device = "png", width = 6.5, height = 4, units = "in")
...
ggplot(data = filter(native_ground_beta_bray_df_long, Site.x == Site.y), aes(x = Site.x, y = native_ground_beta_bray)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-19-Bray-Nat-Veg.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = native_ground_beta_bray_temp, aes(x = Site.x, y = native_ground_beta_bray, fill = Location.x)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-20-Bray-Nat-Veg-Loc.png", device = "png", width = 6.5, height = 4, units = "in")
```
...
ggplot(data = native_ground_beta_bray_temp, aes(x = Site.x, y = native_ground_beta_bray)) +
  ...
  xlab("Site") +
  theme_bw(base_family = "Times")
ggsave("../manuscript/figures/Figure-21-Bray-Nat-Veg-Turn-Loc.png", device = "png", width = 6.5, height = 4, units = "in")
